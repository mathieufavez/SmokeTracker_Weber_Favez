...
public class UpdateHour extends AsyncTask<HourEntity, Void, Void> {

    private AppDatabase database;
    private OnAsyncEventListener callback;
    private Exception exception;

    public UpdateHour(Context context, OnAsyncEventListener callback) {
