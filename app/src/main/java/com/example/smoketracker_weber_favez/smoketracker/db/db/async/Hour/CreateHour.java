...
public class CreateHour extends AsyncTask<HourEntity, Void, Void> {

    private AppDatabase database;
    private OnAsyncEventListener callback;
    private Exception exception;

    public CreateHour(Context context, OnAsyncEventListener callback) {
