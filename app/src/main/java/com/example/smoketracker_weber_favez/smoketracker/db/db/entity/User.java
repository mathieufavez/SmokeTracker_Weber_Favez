...
@Entity(tableName = "users", indices = {@Index(value = { "first_name", "last_name", "email", "brand", "packet_price", "quantity_per_packet", "smoke_per_day_limit"}, unique = true)})
...
public class User {
    ...
    public User( String user_first_name, String user_last_name, String user_email, String user_brand, double user_packet_price, int user_quantity_per_packet, int user_smoke_per_day_limit) {
